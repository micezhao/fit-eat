...
CREATE TABLE `custom_log` (
  `id` bigint(64) unsigned NOT NULL AUTO_INCREMENT,
  `customid` bigint(64) DEFAULT NULL,
  `logchannel` int(4) DEFAULT NULL COMMENT '通过哪一个渠道进行的操作（登录、登出） 1 微信 2 支付宝 3app 4网页',
  `optype` int(4) DEFAULT NULL COMMENT '完成的具体操作 1 登陆 2 登出',
  `ocurtime` datetime DEFAULT NULL COMMENT '发生操作的时间',
  `authtype` int(4) DEFAULT NULL COMMENT '完成操作的凭证类型',
