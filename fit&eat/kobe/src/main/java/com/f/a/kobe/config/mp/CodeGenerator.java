package com.f.a.kobe.config.mp;
...
public class CodeGenerator {
	...
	//生成文件所在项目路径
	private static String baseProjectPath = "/Users/micezhao/fit&eat/fit&eat/kobe/src/main/java";
	
	
	private static String basePackage = "com.f.a.kobe";
	//数据库配置四要素
	...
	private static String password = "891122";
     ...
     public static void main(String[] args) {
    	 ...
    	 tableFillList.add(modified);
    	 
    	 gen.setStrategy(new StrategyConfig()
    			 .setNaming(NamingStrategy.underline_to_camel)// 表名生成策略:下划线转驼峰命名
    			 .setInclude("credential","user_info","login_info") // 【注意：】需要生成的表
